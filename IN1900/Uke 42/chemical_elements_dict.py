...
# elements_10_copy is a copy of the elements_10 dict, so it wont't affect elements_10.
elements_10_copy = elements_10.copy()
elements_10_copy.update({11: "Sodium"})
print(elements_10)
print("\n")
# elements_11 is a reference to the elements_10 dict, so modifying elements_11 is going to directly modify
# elements_10
...
'''
(base) corybalaton@eduroam-193-157-179-38 Uke 42 % /Users/corybalaton/opt/anaconda3/bin/python "/Users/corybalaton/Documents/UiO/IN1900/Uke 42/chemical_elements_dict.py"
